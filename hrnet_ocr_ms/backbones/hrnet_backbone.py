    ...
    def _make_one_branch(self, branch_index, block, num_blocks, num_channels, stride=1):
        ...
        if stride != 1 or self.num_inchannels[branch_index] != (
            ...
            downsample = nn.Sequential(
                ...
                Norm2d(num_channels[branch_index] * block.expansion, momentum=BN_MOMENTUM),
            )
                        ...
                        if k == i - j - 1:
                            ...
                            conv3x3s.append(
                                nn.Sequential(
                                    ...
                                    Norm2d(num_outchannels_conv3x3, momentum=BN_MOMENTUM),
                                )
                            )
                        else:
...
class HighResolutionNet(nn.Module):
    def __init__(self, cfg, **kwargs):
        ...
        self.conv1 = nn.Conv2d(
            cfg.MODEL.INPUT_CHANNELS, 64, kernel_size=3, stride=2, padding=1, bias=False
        )
    ...
    def load_weights(self, pretrained):
        if os.path.isfile(pretrained):
            ...
            print("Backbone: Loading pretrained weights {}".format(pretrained))
